                    ...
                    <Row className='pt-4'>
                        ...
                        <Col lg='6' className='space-y-3'>
                            ...
                            <div className='flex space-x-4'>
                                ...
                                <Button onClick={addToCart} ghost className='text-black border-0 ring-black ring-1 hover:bg-transparent focus:bg-gray-100 -z-10' auto iconRight={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
